...
export const reportColumns:Record<string,CsvColumn[]>={
 sales:[{key:'sale_id',label:'Sale ID'},{key:'number',label:'Receipt number'},{key:'completed_at',label:'Completed at (UTC)'},{key:'product_id',label:'Product ID'},{key:'product_name_snapshot',label:'Product snapshot'},{key:'sku_snapshot',label:'SKU snapshot'},{key:'unit_snapshot',label:'Unit'},{key:'quantity',label:'Quantity',kind:'number'},{key:'unit_price_paisa',label:'Sold unit price (BDT)',kind:'money'},{key:'line_gross_paisa',label:'Line gross before discount (BDT)',kind:'money'},{key:'unit_cost_paisa',label:'Captured reference unit cost (BDT)',kind:'money'},{key:'line_cost_paisa',label:'Captured line cost (BDT)',kind:'money'},{key:'line_profit_before_discount_paisa',label:'Line margin before order discount (BDT)',kind:'money'},{key:'order_discount_paisa',label:'Order discount (BDT; first stable line only)',kind:'money'},{key:'net_profit_contribution_paisa',label:'Net profit contribution (BDT)',kind:'money'}],
